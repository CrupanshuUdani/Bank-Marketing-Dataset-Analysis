...
author: "Crupanshu Ashishbhai Udani"
author: "Karan Jeeten Thakkar"
date: "09/05/20"
output:
...
library(e1071)# Used for training models
...
confusionMatrix(Predict, testing_with_dur_3dropped_col70$y)
```
...
confusionMatrix(Predict, testing_without_dur_3dropped_col70$y)
```
...
confusionMatrix(Predict, testing_with_dur_4dropped_col70$y)
```
...
confusionMatrix(Predict, testing_without_dur_4dropped_col70$y)
```
...
confusionMatrix(Predict, testing_with_dur_3dropped_col50$y)
```
...
confusionMatrix(Predict, testing_without_dur_3dropped_col50$y)
```
...
confusionMatrix(Predict, testing_with_dur_4dropped_col50$y)
```
...
confusionMatrix(Predict, testing_without_dur_4dropped_col50$y)
```
...
confusionMatrix(Predict, testing_with_dur_3dropped_col80$y)
```
...
confusionMatrix(Predict, testing_without_dur_3dropped_col80$y)
```
...
confusionMatrix(Predict, testing_with_dur_4dropped_col80$y)
```
...
confusionMatrix(Predict, testing_without_dur_4dropped_col80$y)
```